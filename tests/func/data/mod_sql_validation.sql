...
/*-18-*/
drop table if exists SCHEMA_SET_AS_DEFAULT.OTHER_TABLE;

/*-19-*/
drop table if exists OTHER_SCHEMA.OTHER_TABLE;

/*-20-*/
drop table if exists OTHER_SCHEMA.TABLE_SET_AS_DEFAULT;

/*-21-*/
drop view if exists SCHEMA_SET_AS_DEFAULT.OTHER_VIEW;
